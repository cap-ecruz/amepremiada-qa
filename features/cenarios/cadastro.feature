...
Funcionalidade: Cadastrar usuario novo
  ...
  Cenario: cadastrar usuario com dados validos
      ...
      E verifico que o botao proximo passo esteja habilitado 1
      E clico no botao proximo passo 1
      ...
      E verifico que o botao proximo passo esteja habilitado 2
      E clico no botao proximo passo 2

      E valido o direcionamento para pagina cadastro passo3
      E clico no campo trocar e-mail e inserir um email novo 
